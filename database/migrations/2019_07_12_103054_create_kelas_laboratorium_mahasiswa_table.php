...
class CreateKelasLaboratoriumMahasiswaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('kelas_laboratorium_mahasiswa', function (Blueprint $table) {
            ...
            $table->float('p1',5,2)->defaul(0)->comment('nilai praktikum 1');
            $table->float('p2',5,2)->defaul(0)->comment('nilai praktikum 2');
            $table->float('p3',5,2)->defaul(0)->comment('nilai praktikum 3');
            $table->float('p4',5,2)->defaul(0)->comment('nilai praktikum 4');
            $table->float('p5',5,2)->defaul(0)->comment('nilai praktikum 5');
            $table->float('ujian',5,2)->defaul(0)->comment('nilai ujian');
            $table->float('dosen',5,2)->defaul(0)->comment('nilai dosen');
            $table->float('akhir',5,2)->defaul(0)->comment('nilai akhir');
            $table->char('grade',3)->default('E')->comment('grade akhir');
